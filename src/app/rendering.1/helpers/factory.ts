    ...
    const factory: Factory = (data?: BaseProps, parent: Component = null, meta?: MetaProps): Component => {
        if (data.type in mapping) {
            ...
            if (!blueprint.composite) {
                const template = blueprint(data);
                const stateless = new StatelessComponent(data, parent, template);
                stateless.meta = meta;
                return stateless;
            }
...
export const createComponent = (element: RzElement): Component | null => {
    // switch here
    // case primitive
    // case stateful
    // case functional
...
export const createElement = (type: RzElementType, props: RzElementProps, ...children: RzElement[]): RzElement | null => {
    return null;
};

const createPrimitiveComponent = (element: RzElement) => {

};

const createStatefulComponent = (element: RzElement) => {

};

const createFunctionalComponent = (element: RzElement) => {
