...
// };
//
// const questCost_resource: FormDefinition = (data: QuestEffect, ent: ConnectedEntities) => {
//     const resources = composeResourceOptions(ent);
//     return [];
// };
//
// const questCost_field: FormDefinition = (data: QuestEffect, ent: ConnectedEntities) => {
//     const fields = composeFieldOptions(ent);
//     return [{
//         controlType: controlTypes.DROPDOWN,
//         label: 'Field',
