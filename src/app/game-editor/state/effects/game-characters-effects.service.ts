...
import { Actions as IActions, SaveCharacterSuccessAction, SaveCharacterFailAction } from '../actions/actions';
...
export class GameCharactersEffectsService {
    ...
    @Effect() saveCharacter: Observable<any> = this.actions$.ofType(actionTypes.SAVE_CHARACTER)
